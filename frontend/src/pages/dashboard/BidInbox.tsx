...
const BidInboxTab: FC = () => {
    ...
    // Real wallet signature for "decryption"
    ...
    if (!address) {
        return (
            <div className="max-w-2xl mx-auto text-center py-16">
                <p className="text-[14px]" style={{ color: "#888" }}>Connect your wallet to view your bid inbox.</p>
            </div>
        );
    }
    ...
    // After "decryption" — show empty state since there are no on-chain bids yet
    return (
